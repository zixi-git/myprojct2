...
#define OLED_SCL_W	PBout(2)
#define OLED_SDA_W	PBout(1)
#define OLED_SDA_R	PBin(1)


void sda_pin_mode(GPIOMode_TypeDef pin_mode)
{
	GPIO_InitTypeDef  GPIO_InitStructure;
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1;		//µÚ7¸ùÒý½Å
...
{ 	
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1|GPIO_Pin_2;		//µÚ6 7¸ùÒý½Å
