...
void sda_pin_mode(GPIOMode_TypeDef pin_mode)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10;	//Ö¸¶¨10ºÅÒý½Å
	GPIO_InitStructure.GPIO_Mode = pin_mode;//ÅäÖÃÎªÊä³ö/ÊäÈëÄ£Ê½
	GPIO_InitStructure.GPIO_OType = GPIO_OType_OD;//¿ªÂ©Êä³ö
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//ËÙ¶ÈÔ½¸ß£¬¹¦ºÄ¾ÍÔ½¸ß£¬µ«ÊÇÏìÓ¦ËÙ¶ÈÒ²¸ü¿ì
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;//²»ÐèÒªÊ¹ÄÜÄÚ²¿ÉÏÏÂÀ­µç×è
...
{ 	
	...
	/*3. ³õÊ¼»¯¸Ã¶Ë¿Ú */
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15;	//Ö¸¶¨15ºÅÒý½Å
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//ÅäÖÃÎªÍÆÍì¹¦ÄÜÄ£Ê½
	GPIO_InitStructure.GPIO_OType = GPIO_OType_OD;//¿ªÂ©Êä³ö
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//ËÙ¶ÈÔ½¸ß£¬¹¦ºÄ¾ÍÔ½¸ß£¬µ«ÊÇÏìÓ¦ËÙ¶ÈÒ²¸ü¿ì
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;//²»ÐèÒªÊ¹ÄÜÄÚ²¿ÉÏÏÂÀ­µç×è
